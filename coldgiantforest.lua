...
local function grow_new_giantforest_paleoredwood_tree(pos)
  ...
  minetest.place_schematic({ x = pos.x - 3, y = pos.y - 0, z = pos.z - 3 },
    modpath .. "/schematics/giantforest_paleoredwood_tree.mts", "0", nil, false)
end
...
stairs.register_stair_and_slab(
  ...
  { choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
  { "livingfloatlands_giantforest_paleoredwood_trunk_top.png", "livingfloatlands_giantforest_paleoredwood_trunk_top.png",
    "livingfloatlands_giantforest_paleoredwood_trunk.png" },
...
default.register_fence(
  "livingfloatlands:fence_paleoredwood_wood",
  {
    ...
    inventory_image =
    "default_fence_overlay.png^livingfloatlands_giantforest_paleoredwood_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
    wield_image =
    "default_fence_overlay.png^livingfloatlands_giantforest_paleoredwood_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
    material = "livingfloatlands:giantforest_paleoredwood_wood",
