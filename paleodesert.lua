...
minetest.register_biome({
	...
	depth_top = 1,
	node_filler = "mcl_core:desert_sandstone",
	depth_filler = 30,
	node_riverbed = "mcl_core:desert_sand",
	depth_riverbed = 3,
	node_dungeon = "mcl_core:desert_stonebrick",
	node_dungeon_alt = "mcl_core:desert_sandstone_brick",
	node_dungeon_stair = "mcl_stairs:desert_sandstone_stair",
	y_max = 31000,
	y_min = 0,
	heat_point = 96,
	humidity_point = 15,
...
local function grow_new_paleodesert_joshua_tree(pos)
	...
	minetest.place_schematic({ x = pos.x - 3, y = pos.y - 0, z = pos.z - 3 },
		modpath .. "/schematics/paleodesert_joshua_tree3.mts", "0", nil, false)
end
...
mcl_stairs.register_stair_and_slab(
	...
	{ choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
	{ "livingfloatlands_paleodesert_joshua_trunk_top.png", "livingfloatlands_paleodesert_joshua_trunk_top.png",
		"livingfloatlands_paleodesert_joshua_trunk.png" },
...
mcl_fences.register_fence_def(
	"livingfloatlands:fence_joshua_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingfloatlands_paleodesert_joshua_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingfloatlands_paleodesert_joshua_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingfloatlands:paleodesert_joshua_wood",
...
local function grow_new_paleodesert_paleopine_tree(pos)
	...
	minetest.remove_node(pos)
	minetest.place_schematic({ x = pos.x - 5, y = pos.y - 0, z = pos.z - 5 },
		modpath .. "/schematics/paleodesert_paleopine.mts", "0", nil, false)
end
...
mcl_stairs.register_stair_and_slab(
	...
	{ choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
	{ "livingfloatlands_paleodesert_paleopine_trunk_top.png", "livingfloatlands_paleodesert_paleopine_trunk_top.png",
		"livingfloatlands_paleodesert_paleopine_trunk.png" },
...
mcl_fences.register_fence_def(
	"livingfloatlands:fence_paleopine_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingfloatlands_paleodesert_paleopine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingfloatlands_paleodesert_paleopine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingfloatlands:paleodesert_paleopine_wood",
		groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
