...
mobs:register_mob("livingfloatlands:gastornis", {
	...
	follow = {
		...
		"farming:seed_oat", "farming:seed_rye", "mobs:meat_raw", "animalworld:rabbit_raw", "animalworld:pork_raw",
		"water_life:meat_raw", "animalworld:chicken_raw", "livingfloatlands:ornithischiaraw",
