...
minetest.register_alias('mcl_core:dirt_with_rainforest_litter', 'mcl_core:dirt_with_grass')
minetest.register_alias('mcl_core:dirt_with_snow', 'mcl_core:dirt_with_grass_snow')
minetest.register_alias('mcl_core:dirt_with_coniferous_litter', 'mcl_core:podzol')
minetest.register_alias('mcl_core:dirt_with_grass', 'mcl_core:dirt_with_grass')
...
minetest.register_alias('mcl_core:clay_brick', 'mcl_core:brick')
...
minetest.register_alias('mcl_core:clay_lump', 'mcl_core:clay_lump')
...
minetest.register_alias('mcl_core:clay', 'mcl_colorblocks:hardened_clay')
...
minetest.register_alias('stairs:stair_coral_deep_ocean_sandstone_block',
    'mcl_stairs:stair_coral_deep_ocean_sandstone_block')
minetest.register_alias('stairs:slab_coral_deep_ocean_sandstone_block',
    'mcl_stairs:slab_coral_deep_ocean_sandstone_block')
minetest.register_alias('stairs:slab_coral_deep_ocean_sandstone_brick',
    'mcl_stairs:slab_coral_deep_ocean_sandstone_brick')
minetest.register_alias('stairs:slab_coral_sandstone_brick', 'mcl_stairs:slab_coral_sandstone_brick')
minetest.register_alias('stairs:stair_coral_deep_ocean_sandstone_brick',
    'mcl_stairs:stair_coral_deep_ocean_sandstone_brick')
minetest.register_alias('stairs:stair_crystal_forest_deep_ocean_sandstone_block',
...
minetest.register_alias('stairs:slab_crystal_forest_deep_ocean_sandstone_block',
    'mcl_stairs:slab_crystal_forest_deep_ocean_sandstone_block')
minetest.register_alias('stairs:slab_crystal_forest_deep_ocean_sandstone_brick',
    'mcl_stairs:slab_crystal_forest_deep_ocean_sandstone_brick')
