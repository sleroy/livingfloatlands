...
minetest.register_biome({
  ...
  node_dungeon_stair = "mcl_stairs:stair_cobble",
  y_max = 31000,
  y_min = 3,
  heat_point = 95,
  humidity_point = 63,
...
local function grow_new_paleojungle_clubmoss_tree(pos)
  ...
  minetest.place_schematic({ x = pos.x - 7, y = pos.y - 0, z = pos.z - 7 },
    modpath .. "/schematics/paleojungle_clubmoss_tree.mts", "0", nil, false)
end
...
mcl_stairs.register_stair_and_slab(
  ...
  { choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
  { "livingfloatlands_paleojungle_clubmoss_trunk_top.png", "livingfloatlands_paleojungle_clubmoss_trunk_top.png",
    "livingfloatlands_paleojungle_clubmoss_trunk.png" },
...
mcl_fences.register_fence_def(
  "livingfloatlands:fence_clubmoss_wood",
  {
    ...
    inventory_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_clubmoss_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
    wield_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_clubmoss_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
...
local function grow_new_paleojungle_conifere_tree(pos)
  ...
  minetest.remove_node(pos)
  minetest.place_schematic({ x = pos.x - 7, y = pos.y - 0, z = pos.z - 8 },
    modpath .. "/schematics/paleojungle_conifere_tree.mts", "0", nil, false)
end
...
mcl_stairs.register_stair_and_slab(
  ...
  { choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
  { "livingfloatlands_paleojungle_conifere_trunk_top.png", "livingfloatlands_paleojungle_conifere_trunk_top.png",
    "livingfloatlands_paleojungle_conifere_trunk.png" },
...
mcl_fences.register_fence_def(
  "livingfloatlands:fence_conifere_wood",
  {
    ...
    inventory_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_conifere_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
    wield_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_conifere_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
...
local function grow_new_paleojungle_paleopalm_tree(pos)
  ...
  minetest.remove_node(pos)
  minetest.place_schematic({ x = pos.x - 4, y = pos.y - 0, z = pos.z - 4 },
    modpath .. "/schematics/paleojungle_paleopalm_tree.mts", "0", nil, false)
end
...
mcl_stairs.register_stair_and_slab(
  ...
  { choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
  { "livingfloatlands_paleojungle_paleopalm_trunk_top.png", "livingfloatlands_paleojungle_paleopalm_trunk_top.png",
    "livingfloatlands_paleojungle_paleopalm_trunk.png" },
...
mcl_fences.register_fence_def(
  "livingfloatlands:fence_paleopalm_wood",
  {
    ...
    texture = "livingfloatlands_paleojungle_conifere_fencewood.png",
    inventory_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_paleopalm_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
    wield_image =
    "default_fence_overlay.png^livingfloatlands_paleojungle_paleopalm_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
