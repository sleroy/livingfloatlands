...
local function grow_new_coldsteppe_pine_tree(pos)
	...
	minetest.place_schematic({ x = pos.x - 6, y = pos.y - 0, z = pos.z - 6 },
		modpath .. "/schematics/livingfloatlands_coldsteppe_pine.mts", "0", nil, false)
end
...
stairs.register_stair_and_slab(
	...
	{ choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
	{ "livingfloatlands_coldsteppe_pine_trunk_top.png", "livingfloatlands_coldsteppe_pine_trunk_top.png",
		"livingfloatlands_coldsteppe_pine_trunk.png" },
...
default.register_fence(
	"livingfloatlands:fence_pine_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingfloatlands:coldsteppe_pine_wood",
...
local function grow_new_coldsteppe_pine2_tree(pos)
	...
	minetest.place_schematic({ x = pos.x - 7, y = pos.y - 0, z = pos.z - 7 },
		modpath .. "/schematics/livingfloatlands_coldsteppe_pine2.mts", "0", nil, false)
end
...
stairs.register_stair_and_slab(
	...
	{ choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
	{ "livingfloatlands_coldsteppe_pine_trunk_top.png", "livingfloatlands_coldsteppe_pine2_trunk_top.png",
		"livingfloatlands_coldsteppe_pine2_trunk.png" },
...
default.register_fence(
	"livingfloatlands:fence_pine2_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine2_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine2_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingfloatlands:coldsteppe_pine2_wood",
		groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
...
local function grow_new_coldsteppe_pine3_tree(pos)
	...
	minetest.place_schematic({ x = pos.x - 4, y = pos.y - 0, z = pos.z - 4 },
		modpath .. "/schematics/livingfloatlands_coldsteppe_pine3.mts", "0", nil, false)
end
...
stairs.register_stair_and_slab(
	...
	{ choppy = 2, oddly_breakable_by_hand = 1, flammable = 3 },
	{ "livingfloatlands_coldsteppe_pine_trunk_top.png", "livingfloatlands_coldsteppe_pine3_trunk_top.png",
		"livingfloatlands_coldsteppe_pine3_trunk.png" },
...
default.register_fence(
	"livingfloatlands:fence_pine3_wood",
	{
		...
		inventory_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine3_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		wield_image =
		"default_fence_overlay.png^livingfloatlands_coldsteppe_pine3_wood.png^default_fence_overlay.png^[makealpha:255,126,126",
		material = "livingfloatlands:coldsteppe_pine3_wood",
		groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
